...
- 슬라이드 **15장, 총 111비트**(개정 시 이 숫자도 갱신할 것). 한 장은 2~11비트이고 비트마다 텍스트가 넘어간다.
- 자동 진행 없음 — 클릭/스페이스로 넘긴다. 읽는 속도는 플레이어가 정한다.
- **건너뛰기 항상 노출.** 2회차 플레이어를 붙잡지 않는다.
- **등록은 P12 안에서 끝난다.** 이름 칸과 서명란이 한 장에 있고, 둘 다 채워야 다음으로 넘어간다.
  화면을 나누지 않는 이유는 그것이 **한 번의 행위**이기 때문이다 — 만물대장에 리뷰어로 오르는 것.
  (구 설계에서는 슬라이드쇼 뒤에 별도 서명 화면 S05가 있었다. ADR-020으로 통합)
- 슬라이드와 등록은 **한 흐름**이다 —
...
>
> **소환사** 올리는 건 아무나 합니다. 예나 지금이나요.
> 대신 잘못 올라간 건 신이 지워 줬어요. 그래서 아무 문제가 없었습니다.
>
> **소환사** 지금은 안 지워집니다. 한 번 올라간 건 그냥 거기 있어요.
> 틀린 것도, 작정하고 쓴 것도요.
>
> **소환사** 이건 만물체험단 패입니다. 별 수가 곧 발언권이에요.
>
> **소환사** 그런데 어느 날 신이 사라졌습니다.
> 이유도 없고 예고도 없었어요.
>
> **소환사** 그때부터 아무것도 안 지워집니다.
...
>
> **소환사** 신이 하던 걸 자기가 하겠다고 했습니다. 자기가 걸러 주겠다고요.
>
> **소환사** 그자를 까는 글은 지금도 대장에 다 있습니다. 한 줄도 안 지워졌어요.
>
> **소환사** 그런데 아무도 안 누릅니다. 그자가 쓴 답글이 항상 더 많이 눌리거든요.
> 여기선 그게 지운 거랑 같습니다.
>
> **소환사** 항의한 사람들한테는 별 하나짜리를 써서 올렸습니다.
> 그 글도 사람들이 눌러 줬어요. 별이 바닥에 닿으면 사라집니다.
>
> **소환사** 그자가 지운 게 아닙니다. 그자가 쓰고, 사람들이 지웠어요.
>
> **소환사** 그렇게 나머지가 없어졌습니다.
>
> **소환사** 저는 안 없어졌습니다. 항의를 안 했으니까요.
>
> **소환사** 그날 저는 도망쳤습니다.
>
> 그의 목에 걸린 나무 패에는 별이 하나 남아 있었다.
>
> **소환사** 이건 그자가 깎은 게 아닙니다.
> 도망친 사람을 좋게 써 줄 사람이 어디 있겠습니까.
>
> **소환사** ─ 베스트 리뷰어.
>
...
> 그리고 저희부터 없어졌습니다.
>
> **소환사** 여기 사람으로는 안 됩니다. 이름이 대장에 있으니까요.
> 누가 썼는지 나오면 그 사람 앞으로 별 하나짜리가 올라옵니다. 그걸로 끝입니다.
>
> 그는 자기 목을 만져 봤다. 아무것도 걸려 있지 않았다.
>
> **소환사** 당신은 올려도 되받을 데가 없습니다. 그래서 이 세계에 이름이 없는 사람을 부릅니다.
>
> **소환사** 그 기록을 제가 직접 찾아내는 건 아닙니다. 빼돌려 주는 사람이 따로 있어요.
>
> **소환사** 물류를 쥔 사람이 하나 남아 있는데, 그자 밑에서 일합니다.
> 배송 오류로 처리해서 삼 년째 저한테 넘겨 줍니다.
>
> **소환사** 죽는 순간까지 뭔가를 평가하고 있던 사람들의 기록입니다.
> 어느 대장에도 올라가 있지 않은 걸로요. 그자가 마지막으로 뽑힌 그날부터 이 일을 했습니다.
> 삼 년째입니다.
>
...
> **플레이어 입력 슬라이드.** 이름과 서명을 **한 장에서 함께** 받는다(ADR-020).
> 저장: `localStorage['reviewhero.penname']` · `localStorage['reviewhero.sig']`.
> 둘 다 채우기 전에는 다음 비트로 넘어가지 않는다.
...
> 이 세계 규칙은 그런 경우를 상정한 적이 없습니다. 그래서 통하고요.
>
> **소환사** 이름 밑에 하나 그으셔야 합니다. 아무 모양이나요.
>
> **소환사** 앞으로 글을 쓰고 끝에 그걸 그으면, 그게 올리는 겁니다.
> 대장이 대조해 보고 맞으면 그 자리에서 올라가요.
>
> **소환사** 사람들이 보는 건 이름입니다. 서명은 대장만 봅니다.
>
> [PLAYER_INPUT: 만물대장 리뷰어 등록 — 이름과 서명]
>
> 그는 그 이름을 적고, 밑에 선을 그었다. 「{필명}」.
